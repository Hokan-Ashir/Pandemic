...
//{
   ...
   friend Pyramid  operator* (C Pyramid &pyramid,   Flt      f);
   friend Pyramid  operator/ (C Pyramid &pyramid,   Flt      f);
   friend Pyramid  operator* (C Pyramid &pyramid, C Matrix3 &m);
   friend Pyramid  operator* (C Pyramid &pyramid, C Matrix  &m);
