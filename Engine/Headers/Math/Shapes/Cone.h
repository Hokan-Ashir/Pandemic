...
struct Cone // Cone Shape
{
   ...
   friend Cone  operator+ (C Cone    &cone, C Vec     &v);
   friend Cone  operator* (C Cone    &cone, C Flt      f);
   friend Cone  operator* (C Cone    &cone, C Matrix3 &m);
   friend Cone  operator* (C Cone    &cone, C Matrix  &m);
