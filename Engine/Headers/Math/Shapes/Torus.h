...
struct Torus // Torus Shape
{
   ...
   friend Torus  operator+ (C Torus   &torus, C Vec     &v);
   friend Torus  operator- (C Torus   &torus, C Vec     &v);
   friend Torus  operator* (C Torus   &torus, C Flt      f);
   friend Torus  operator/ (C Torus   &torus, C Flt      f);
   friend Torus  operator* (C Torus   &torus, C Matrix3 &m);
   friend Torus  operator* (C Torus   &torus, C Matrix  &m);
