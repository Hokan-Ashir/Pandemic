...
inline Flt DistPointPlane(C Vec2  &point,                     C Vec2  &plane_normal) {return Dot(point, plane_normal);} // this function assumes that plane position is Vec(0,0,0)
inline Dbl DistPointPlane(C VecD2 &point,                     C VecD2 &plane_normal) {return Dot(point, plane_normal);} // this function assumes that plane position is Vec(0,0,0)
...
inline Dbl DistPointPlane(C VecD  &point,                     C VecD  &plane_normal) {return Dot(point, plane_normal);} // this function assumes that plane position is Vec(0,0,0)
...
Flt DistPointPlaneRay(C Vec2  &point,                     C Vec2  &plane_normal, C Vec2  &ray); // this function assumes that plane position is Vec(0,0,0)
Dbl DistPointPlaneRay(C VecD2 &point,                     C VecD2 &plane_normal, C VecD2 &ray); // this function assumes that plane position is Vec(0,0,0)
Flt DistPointPlaneRay(C Vec   &point,                     C Vec   &plane_normal, C Vec   &ray); // this function assumes that plane position is Vec(0,0,0)
Dbl DistPointPlaneRay(C VecD  &point,                     C VecD  &plane_normal, C VecD  &ray); // this function assumes that plane position is Vec(0,0,0)
...
inline Flt Dist(C VecD2 &point, C PlaneD2 &plane) {return DistPointPlane(point, plane.pos, plane.normal);}
inline Flt Dist(C Vec   &point, C Plane   &plane) {return DistPointPlane(point, plane.pos, plane.normal);}
inline Flt Dist(C VecD  &point, C PlaneD  &plane) {return DistPointPlane(point, plane.pos, plane.normal);}
...
Vec2  PointOnPlane(C Vec2  &point,                     C Vec2  &plane_normal); // this function assumes that plane position is Vec(0,0,0)
VecD2 PointOnPlane(C VecD2 &point,                     C VecD2 &plane_normal); // this function assumes that plane position is Vec(0,0,0)
Vec   PointOnPlane(C Vec   &point,                     C Vec   &plane_normal); // this function assumes that plane position is Vec(0,0,0)
VecD  PointOnPlane(C VecD  &point,                     C VecD  &plane_normal); // this function assumes that plane position is Vec(0,0,0)
...
Vec2  PointOnPlaneRay(C Vec2  &point,                     C Vec2  &plane_normal, C Vec2  &ray); // this function assumes that plane position is Vec(0,0,0)
VecD2 PointOnPlaneRay(C VecD2 &point,                     C VecD2 &plane_normal, C VecD2 &ray); // this function assumes that plane position is Vec(0,0,0)
Vec   PointOnPlaneRay(C Vec   &point,                     C Vec   &plane_normal, C Vec   &ray); // this function assumes that plane position is Vec(0,0,0)
VecD  PointOnPlaneRay(C VecD  &point,                     C VecD  &plane_normal, C VecD  &ray); // this function assumes that plane position is Vec(0,0,0)
...
Bool SweepPointPlane(C Vec2  &point, C Vec2  &move, C Plane2  &plane, Flt *hit_frac=NULL, Vec2  *hit_pos=NULL, Bool two_sided=false);
Bool SweepPointPlane(C VecD2 &point, C VecD2 &move, C PlaneD2 &plane, Dbl *hit_frac=NULL, VecD2 *hit_pos=NULL, Bool two_sided=false);
Bool SweepPointPlane(C Vec   &point, C Vec   &move, C Plane   &plane, Flt *hit_frac=NULL, Vec   *hit_pos=NULL, Bool two_sided=false);
Bool SweepPointPlane(C VecD  &point, C VecD  &move, C PlaneD  &plane, Dbl *hit_frac=NULL, VecD  *hit_pos=NULL, Bool two_sided=false);
