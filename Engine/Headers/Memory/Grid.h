...
T1(TYPE) struct Grid : private _Grid // Grid
{
   ...
   // call custom function on grid cells (multi-threaded version)
                   void mtFunc(               void func(Cell<TYPE> &cell, Ptr        user)                      , Int threads=Cpu.cores()); // call 'func' on all existing grid cells
   T1(USER_DATA)   void mtFunc(               void func(Cell<TYPE> &cell, USER_DATA *user), USER_DATA *user=NULL, Int threads=Cpu.cores()); // call 'func' on all existing grid cells
   T1(USER_DATA)   void mtFunc(               void func(Cell<TYPE> &cell, USER_DATA &user), USER_DATA &user     , Int threads=Cpu.cores()); // call 'func' on all existing grid cells
                   void mtFunc(C RectI &rect, void func(Cell<TYPE> &cell, Ptr        user)                      , Int threads=Cpu.cores()); // call 'func' on all existing grid cells in specified rectangle
   T1(USER_DATA)   void mtFunc(C RectI &rect, void func(Cell<TYPE> &cell, USER_DATA *user), USER_DATA *user=NULL, Int threads=Cpu.cores()); // call 'func' on all existing grid cells in specified rectangle
   T1(USER_DATA)   void mtFunc(C RectI &rect, void func(Cell<TYPE> &cell, USER_DATA &user), USER_DATA &user     , Int threads=Cpu.cores()); // call 'func' on all existing grid cells in specified rectangle

   // call custom function on grid cells (multi-threaded version with per thread data)
   T1(PER_THREAD_DATA           )   void mtFuncWithPerThreadData(               void func(Cell<TYPE> &cell, Int thread_index, PER_THREAD_DATA &per_thread_data, Ptr        user)                      , Int threads=Cpu.cores()); // call 'func' on all existing grid cells
   T2(PER_THREAD_DATA, USER_DATA)   void mtFuncWithPerThreadData(               void func(Cell<TYPE> &cell, Int thread_index, PER_THREAD_DATA &per_thread_data, USER_DATA *user), USER_DATA *user=NULL, Int threads=Cpu.cores()); // call 'func' on all existing grid cells
   T2(PER_THREAD_DATA, USER_DATA)   void mtFuncWithPerThreadData(               void func(Cell<TYPE> &cell, Int thread_index, PER_THREAD_DATA &per_thread_data, USER_DATA &user), USER_DATA &user     , Int threads=Cpu.cores()); // call 'func' on all existing grid cells
   T1(PER_THREAD_DATA           )   void mtFuncWithPerThreadData(C RectI &rect, void func(Cell<TYPE> &cell, Int thread_index, PER_THREAD_DATA &per_thread_data, Ptr        user)                      , Int threads=Cpu.cores()); // call 'func' on all existing grid cells in specified rectangle
   T2(PER_THREAD_DATA, USER_DATA)   void mtFuncWithPerThreadData(C RectI &rect, void func(Cell<TYPE> &cell, Int thread_index, PER_THREAD_DATA &per_thread_data, USER_DATA *user), USER_DATA *user=NULL, Int threads=Cpu.cores()); // call 'func' on all existing grid cells in specified rectangle
   T2(PER_THREAD_DATA, USER_DATA)   void mtFuncWithPerThreadData(C RectI &rect, void func(Cell<TYPE> &cell, Int thread_index, PER_THREAD_DATA &per_thread_data, USER_DATA &user), USER_DATA &user     , Int threads=Cpu.cores()); // call 'func' on all existing grid cells in specified rectangle
