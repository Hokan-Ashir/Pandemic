...
/******************************************************************************/
enum WIN_IO_MODE // WindowIO mode
{
   WIN_IO_LOAD, // load file
   WIN_IO_SAVE, // save file
   WIN_IO_DIR , // directory select
};
enum WIN_IO_PATH_MODE // WindowIO title bar path display mode
{
...
enum WIN_IO_EXT_MODE // WindowIO extension append mode
{
