...
const_mem_addr struct Viewport4
{
   ...
   enum ORIENT_MODE // orientation mode
   {
 ...
 C Rect&       rect       ()C {return _rect       ;}   Viewport4& rect       (C Rect     &rect ); // get/set viewport rectangle
   ...
   Flt         perspFov   ()C {return _persp_fov  ;}   Viewport4& perspFov   (Flt         fov  ); // get/set perspective FOV , default=DegToRad(75)
   ...
   Viewport4& moveTo           (C Vec      &pos    ); // move camera focus to 'pos'
...
private:
   ...
   //{
      Bool       arrow_pushed[DIRE_NUM];
      Rect       arrow_rect  [DIRE_NUM];
      Viewport4 *v4;
      View      *view;
