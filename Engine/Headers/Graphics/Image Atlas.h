...
struct ImageAtlas // Image Atlas, set of multiple images packed into as few textures as possible
{
   ...
   {
      Byte  image_index  ; // index of the image in 'images' in which the part is located, or 0xFF if this part is completely transparent and is not stored in an image
