...
private:
   ...
   ShaderTech *_shader[2][2]; // [F][P] F-Fullscreen, P-Palette
};
/******************************************************************************/
...
{
   void scheduleDrawBlend(C Vec &pos); // call this method inside RM_PREPARE rendering mode to schedule automatic call to 'drawBlend' method, 'pos'=object position (used for correct depth-sorting calculation)
...
/******************************************************************************/
void DrawLaser(C Color &color, C Color &middle_color, Flt middle_exponent, Flt radius, Bool sharp_ending, C Memp<Vec> points); // draw laser effect using active matrix onto the screen, 'points'=array of laser points, this should be called in RM_SOLID and RM_AMBIENT modes
/******************************************************************************/
