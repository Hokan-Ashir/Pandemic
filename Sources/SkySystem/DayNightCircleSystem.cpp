...
namespace pan {
	...
	DayNightCircleSystem::DayNightCircleSystem() : sunHeightOverHorizont(0) {
	...
	Flt DayNightCircleSystem::getHeightOverHorizont(Flt hour) const	{
	...
	void DayNightCircleSystem::setSkyColour(Flt sunHeightOverHorizont) {
	...
	void DayNightCircleSystem::setSunHeightOverHorizont(Flt sunHeightOverHorizont) {
